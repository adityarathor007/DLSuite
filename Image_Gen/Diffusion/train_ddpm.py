...
def train(args):
    ...
    for epoch_idx in range(num_epochs):
        ...
        for im in tqdm(mnist_loader):
            ...
            # schedular adds noise to images according to timestep 
            noisy_im=schedular.add_noise(im,noise,t)
            noise_pred=model(noisy_im,t)

            # backpropogate based on the loss between the noise prediction by the model and the actual noise we added
