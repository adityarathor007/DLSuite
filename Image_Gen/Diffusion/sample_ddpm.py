...
from linear_noise_scheduler import LinearNoiseSchedular
...
def sample(model,scheduler,train_config,model_config,diffusion_config):
    ...
    # Samples stepwise by going backward one timestep at a time and the x0 prediction
    ...
    for i in tqdm(reversed(range(diffusion_config['num_timesteps']))):
        ...
        # reverse process of scheduler to get mean of xt-1 and estimate of the original image
